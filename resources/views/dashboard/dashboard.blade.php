                    ...
                    <div class="card-group m-b-30">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="mb-0">Overall Employees 120</p>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                    ...
                    <div class="card flex-fill">
                        <div class="card-body">
                            ...
                            <div class="leave-info-box">
                                ...
                                <div class="row align-items-center mt-3">
                                    <div class="col-6">
                                        <h6 class="mb-0">5 Aug 2026</h6> <span class="text-sm text-muted">Leave Date</span> </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    ...
                                                    <a href="client-profile.html">Nai Panhavorn <span>CEO</span></a>
                                                </h2>
                                            </td>
                                            <td>vorn007@gmail.com</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="#" class="avatar"><img alt="" src="assets/img/profiles/avatar-19.jpg"></a>
                                                    <a href="client-profile.html">Elon Mask <span>Manager</span></a>
                                                </h2>
                                            </td>
                                            <td>lm@gmail.com</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    ...
                                                    <a href="client-profile.html">Travis Scott <span>CEO</span></a>
                                                </h2>
                                             </td>
                                            <td>ts@gmail.com</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    ...
                                                    <a href="client-profile.html"> Cristiano Ronaldo <span>CEO</span></a>
                                                </h2>
                                            </td>
                                            <td>cr7@gmail.com</td>
                                            <td>
